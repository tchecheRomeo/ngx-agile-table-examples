...
import {ColumnTable, ActionButtonTable, NgxAgileTableService, RowTable} from 'ngx-agile-table';
...
export class AppComponent implements OnInit {
  ...
  constructor(private service: NgxAgileTableService, private renderer: Renderer2) {
